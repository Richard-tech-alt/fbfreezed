...
//     // Optional: Lock scroll (already done above)
//     document.body.style.overflow = "hidden"

//     // Optional: Prevent scroll bounce/pull-down refresh on mobile
...
//             id="emergencyPopup"
//             ref={popupRef}
//             className="fixed inset-0 flex items-center justify-center z-50 p-4 backdrop-blur-lg fullscreen-container"
//             tabIndex={-1}
//             onKeyDown={(e) => {
